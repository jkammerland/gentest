...
| `028` | make Windows path-depth and short-root behavior robust | `Done` | `62301539`, `2026-04-14` Windows inventory evidence, `pending-commit` | reopened deep-checkout path-budget failures are fixed and revalidated from a normal native Windows checkout root |
