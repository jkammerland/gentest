...
| `025` | move source transformation logic out of `GentestCodegen.cmake` | `Done` | `1db3854b`, `2026-04-14` Windows inventory evidence, `pending-commit` | reopened native Windows nested source-inspection helper/backend failures are fixed and revalidated |
