...
| `024` | unify manifest and TU-wrapper emission pipelines | `Done` | `ea142481`, `2026-04-14` closure audit, `pending-commit` | shared registration/body assembly is already unified; the remaining manifest-vs-TU differences are shell/orchestration level and the acceptance slice stays green |
