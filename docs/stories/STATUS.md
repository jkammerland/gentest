...
| `030` | simplify mock codegen model, discovery, and render helpers | `Done` | `ec0a4e70`, `92982704`, `b8fe671f`, `b2519282`, `2026-04-14` closure audit, `pending-commit` | current branch state already satisfies the story scope; closure evidence is the explicit audit plus the full mock-sensitive acceptance slice |
