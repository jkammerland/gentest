...
| `029` | unify tool and CMake codegen output naming contracts | `Done` | `1530eb71`, `cfaeccd2`, `4818e6c2`, `e9fbeade`, `6c99aa50`, `2580562c`, `2026-04-14` closure audit, `pending-commit` | module-wrapper and mock-output filename families are now CMake-owned explicit paths consumed by the tool; no cross-layer filename synthesis remains in the story scope |
