...
| `034` | make codegen own artifact planning and same-module registration | `Open` | story created `2026-04-17` | codegen does not yet emit a build-system-neutral artifact manifest, and module registration still relies on build-system-specific orchestration/source classification |
