...
- Historical per‑TU registration wrappers (removed): [`docs/stories/003_per_tu_registration_wrappers.md`](stories/003_per_tu_registration_wrappers.md)
...
- Additive textual header-declaration registration: [`docs/stories/036_textual_declaration_only_registration.md`](stories/036_textual_declaration_only_registration.md)
