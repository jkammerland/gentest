...
- Codegen no `.cpp` includes + auto sources: [`docs/stories/004_codegen_no_cpp_includes_and_auto_sources.md`](stories/004_codegen_no_cpp_includes_and_auto_sources.md)
