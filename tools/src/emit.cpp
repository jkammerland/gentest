...
std::string render_textual_mock_public_header(const TextualMockPublicHeaderRenderSpec &spec) {
    const std::string defs_include     = include_literal_for_path(spec.definitions_source_path);
    ...
    const std::string api_header   = spec.mock_api_header.empty() ? std::string{"gentest/mock.h"} : spec.mock_api_header;
    std::string       header;
    ...
    header.append("// This file is auto-generated by gentest_codegen.\n"
                  "// Do not edit manually.\n"
                  "#pragma once\n\n");
    if (spec.suppress_gentest_auto_mock_include) {
        header.append("#define GENTEST_NO_AUTO_MOCK_INCLUDE 1\n");
    }
    if (spec.suppress_gentest_expect_call_macros) {
    ...
    if ((!mocks_consumed_by_registration && !mocks.empty()) || have_mock_paths) {
        ...
        if (!opts.mock_public_header_path.empty()) {
            ...
            const TextualMockPublicHeaderRenderSpec public_header_spec{
                ...
                .mock_api_header =
                    opts.mock_backend == MockBackend::Gentest ? std::string{"gentest/mock.h"} : std::string{"gentest/mock_fwd.h"},
                .suppress_gentest_auto_mock_include  = true,
                .suppress_gentest_expect_call_macros = opts.mock_backend != MockBackend::Gentest,
            };
