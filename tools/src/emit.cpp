...
std::string render_textual_suite_wrapper_source(const fs::path &source_path, const fs::path &wrapper_out, const fs::path &header_out) {
    const std::string source_include = include_literal_for_path(source_path);
    const std::string header_include = include_literal_relative_to(wrapper_out, header_out);
...
std::string render_textual_mock_defs_wrapper_source(const fs::path &defs_path, const fs::path &wrapper_out, const fs::path &header_out) {
    const std::string defs_include   = include_literal_for_path(defs_path);
    const std::string header_include = include_literal_relative_to(wrapper_out, header_out);
    return fmt::format("// This file is auto-generated by gentest_codegen.\n"
                       "// Do not edit manually.\n\n"
...
std::string render_textual_mock_public_header(const fs::path &defs_path, const fs::path &public_header_out,
                                              const fs::path &registry_header_out, const fs::path &impl_header_out) {
    const std::string defs_include     = include_literal_for_path(defs_path);
    const std::string registry_include = include_literal_relative_to(public_header_out, registry_header_out);
    const std::string impl_include     = include_literal_relative_to(public_header_out, impl_header_out);
    return fmt::format("// This file is auto-generated by gentest_codegen.\n"
                       "// Do not edit manually.\n"
                       "#pragma once\n\n"
...
int emit(const CollectorOptions &opts, const std::vector<TestCaseInfo> &cases, const std::vector<FixtureDeclInfo> &fixtures,
    ...
    if (!opts.tu_output_dir.empty()) {
        ...
        parallel_for(opts.sources.size(), jobs, [&](std::size_t idx) {
            ...
            if (!opts.textual_wrapper_outputs.empty()) {
                ...
                const std::string textual_wrapper_source =
                    opts.discover_mocks ? render_textual_mock_defs_wrapper_source(source_path, textual_wrapper_out, header_out)
                                        : render_textual_suite_wrapper_source(source_path, textual_wrapper_out, header_out);
    ...
    if ((!mocks_consumed_by_registration && !mocks.empty()) || have_mock_paths) {
        ...
        if (!opts.mock_public_header_path.empty()) {
            ...
            const std::string public_header = render_textual_mock_public_header(
                fs::path{opts.sources.front()}, opts.mock_public_header_path, opts.mock_registry_path, opts.mock_impl_path);
