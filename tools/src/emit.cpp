...
std::string render_same_module_registration_source(std::string_view module_name, std::string_view registration_header_name,
                                                   const std::vector<const MockClassInfo *> &source_mocks, bool has_registrations,
                                                   bool needs_full_registration_support) {
    std::string rendered;
            ...
            if (is_module_interface_source(opts, source_path)) {
                ...
                if (!opts.module_registration_outputs.empty()) {
                    ...
                    const std::string registration_source =
                        render_same_module_registration_source(module_it->second, header_out.filename().string(), source_mocks,
                                                               !tu_cases.empty() || !tu_fixtures.empty(), needs_full_registration_support);
