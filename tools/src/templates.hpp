...
// - Main file (test_impl):
//     {{INCLUDE_SOURCES}}, {{WRAPPER_SUPPORT_COMMON}}, {{GLOBAL_WRAPPER_IMPLS}},
//     {{REGISTRATION_COMMON}}, {{CASE_INITS}},
...
inline constexpr std::string_view tu_registration_impl = R"CPP(// This file is auto-generated by gentest_codegen.
// Do not edit manually.
