...
inline constexpr std::string_view tu_impl = R"CPP(// This file is auto-generated by gentest_codegen.
// Do not edit manually.
...
namespace gentest::generated {
void {{REGISTER_FN}}() { gentest::detail::register_cases(std::span{kCases}); }
} // namespace gentest::generated
