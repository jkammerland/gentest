...
inline constexpr std::string_view fuzz_stub_impl = R"CPP(// This file is auto-generated by gentest_codegen.
// Do not edit manually.

// No fuzzing backend selected (--fuzz-backend=none).

// Include fuzz target sources so target functions are visible.
{{INCLUDE_SOURCES}}
)CPP";;

inline constexpr std::string_view fuzztest_impl = R"CPP(// This file is auto-generated by gentest_codegen.
// Do not edit manually.
