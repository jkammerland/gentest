...
TypeKind classify_type(std::string_view type_name) {
    ...
    if (t.find("string_view") != std::string::npos || t.find("string") != std::string::npos || t.find("char*") != std::string::npos ||
        t.find("wchar_t*") != std::string::npos || t.find("char8_t*") != std::string::npos || t.find("char16_t*") != std::string::npos ||
        t.find("char32_t*") != std::string::npos) return TypeKind::String;
...
std::string quote_for_type(TypeKind kind, std::string_view token, std::string_view type_name) {
    ...
    case TypeKind::String: {
        ...
        const char* prefix = "";
        if (n.find("wstring") != std::string::npos || n.find("wchar_t*") != std::string::npos) prefix = "L";
        else if (n.find("u8string") != std::string::npos || n.find("char8_t*") != std::string::npos) prefix = "u8";
        else if (n.find("u16string") != std::string::npos || n.find("char16_t*") != std::string::npos) prefix = "u";
        else if (n.find("u32string") != std::string::npos || n.find("char32_t*") != std::string::npos) prefix = "U";
        std::string out;
        out += prefix;
