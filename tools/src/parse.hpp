...
auto collect_gentest_attributes_for(const clang::FunctionDecl &func, const clang::SourceManager &sm) -> AttributeCollection;
...
// Used to detect fixture-level flags such as `fixture(...)`.
auto collect_gentest_attributes_for(const clang::CXXRecordDecl &rec, const clang::SourceManager &sm) -> AttributeCollection;

auto collect_gentest_attributes_for(const clang::NamespaceDecl &ns, const clang::SourceManager &sm) -> AttributeCollection;
