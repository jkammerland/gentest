...
int main() {
    ...
    gentest::expect(alias_mock, &fixture::ModuleService::compute).times(1).with(3).returns(15);
    fixture::ModuleService *alias_service = &alias_mock;
    if (alias_service->compute(3) != 15) {
        return 1;
    }

    gentest::mock<fixture::ModuleService> raw_mock;
    gentest::expect(raw_mock, &fixture::ModuleService::compute).times(1).with(4).returns(20);
    fixture::ModuleService *raw_service = &raw_mock;
    if (raw_service->compute(4) != 20) {
        return 2;
    }
