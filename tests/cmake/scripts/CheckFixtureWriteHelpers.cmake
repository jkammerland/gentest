...
function(gentest_fixture_quote_posix_shell_arg out_var value)
  set(_quoted "${value}")
  set(_single_quote_escape [=['"'"']=])
  string(REPLACE "'" "${_single_quote_escape}" _quoted "${_quoted}")
  set(${out_var} "'${_quoted}'" PARENT_SCOPE)
endfunction()

function(gentest_fixture_join_posix_shell_command out_var)
  set(_parts)
  foreach(_arg IN LISTS ARGN)
    gentest_fixture_quote_posix_shell_arg(_quoted_arg "${_arg}")
    list(APPEND _parts "${_quoted_arg}")
  endforeach()
  string(JOIN " " _command ${_parts})
