...
set(_public_header "${_build_dir}/generated/mocks/public/manual_include_whitespace_mocks.hpp")
if(NOT EXISTS "${_public_header}")
  message(FATAL_ERROR "Expected explicit mock header surface was not written: ${_public_header}")
endif()
...
string(FIND "${_wrapper_text}" "manual_include_whitespace_mocks.hpp\"" _explicit_include_pos)
string(FIND "${_wrapper_text}" "# include \"gentest/mock_codegen.h\"" _manual_spaced_pos)
string(FIND "${_wrapper_text}" "mock_codegen.h" _mock_codegen_pos)

if(_module_pos EQUAL -1)
  message(FATAL_ERROR "Expected generated wrapper to contain the named module declaration.\n${_wrapper_text}")
endif()
if(_explicit_include_pos EQUAL -1)
  message(FATAL_ERROR
    "Expected generated wrapper to preserve the explicit mock header include in ${_wrapper}.\n${_wrapper_text}")
endif()
if(_explicit_include_pos GREATER _module_pos)
  message(FATAL_ERROR
    "Expected the explicit mock header include to stay in the global module fragment in ${_wrapper}.\n${_wrapper_text}")
endif()
if(NOT _manual_spaced_pos EQUAL -1)
  message(FATAL_ERROR
    "Expected generated wrapper to stop carrying the old spaced mock_codegen include in ${_wrapper}.\n${_wrapper_text}")
endif()
if(NOT _mock_codegen_pos EQUAL -1)
  message(FATAL_ERROR
    "Expected explicit mock header flow to stop referencing gentest/mock_codegen.h in ${_wrapper}.\n${_wrapper_text}")
endif()
