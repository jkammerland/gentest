...
file(READ "${SOURCE_FILE}" _source_contents)
if(NOT "${_clang_major}" STREQUAL "" AND NOT _clang_major VERSION_LESS 23 AND
   _source_contents MATCHES "#[ \t]*(if|elif)[^\r\n]*[\r\n]+[ \t]*(export[ \t]+)?module[ \t]")
  gentest_skip_test(
    "preprocessor-condition module scan regression: Clang ${_clang_major} rejects module declarations controlled by preprocessor conditionals")
  return()
endif()
