...
if(_llvm_dir STREQUAL "" OR _clang_dir STREQUAL "")
  message(FATAL_ERROR
    "Failed to locate supported LLVM/Clang CMake package directories for the Bazel textual consumer smoke check.\n"
...
if(NOT _bazel_bin_rc EQUAL 0 OR _bazel_bin_out STREQUAL "")
  message(FATAL_ERROR
    "Failed to resolve bazel-bin for the Bazel textual consumer smoke check.\n"
    "bazel: ${_bazel}\n"
    "bazel version: ${_bazel_version_text}\n"
    "output root: ${_bazel_output_root}\n"
    "stdout:\n${_bazel_bin_out}\n"
...
if(NOT _log_sink_rc EQUAL 0)
  message(FATAL_ERROR
    "Running the Bazel textual consumer log sink case failed.\n"
    "stdout:\n${_log_sink_out}\n"
    "stderr:\n${_log_sink_err}")
endif()
