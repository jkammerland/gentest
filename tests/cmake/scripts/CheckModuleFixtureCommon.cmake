...
function(gentest_clang_major_version out_var compiler_path)
  set(${out_var} "" PARENT_SCOPE)
  gentest_compiler_version_output(_version_output "${compiler_path}")
  if(_version_output MATCHES "clang version ([0-9]+)")
...
function(gentest_make_compile_only_command_args out_var)
  set(one_value_args COMPILER COMPILER_ARG1 STD SOURCE OBJECT)
  ...
  if(DEFINED MAKE_COMPILER_ARG1 AND NOT "${MAKE_COMPILER_ARG1}" STREQUAL "")
    separate_arguments(_compiler_arg1_args NATIVE_COMMAND "${MAKE_COMPILER_ARG1}")
    list(APPEND _args ${_compiler_arg1_args})
  endif()
