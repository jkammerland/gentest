...
if(NOT DEFINED REQUIRED_SUBSTRING)
  message(FATAL_ERROR "CheckAllureResultWriteFailure.cmake: REQUIRED_SUBSTRING not set")
endif()
...
if(_pos EQUAL -1)
  message(FATAL_ERROR "Expected substring not found in infra result: '${REQUIRED_SUBSTRING}'. Content:\n${_content}\n\nOutput:\n${_all}")
endif()
