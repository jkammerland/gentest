...
function(_gentest_assert_codegen_command_has_pool ninja_text command_token context)
  ...
  if(_command_end EQUAL -1)
    message(FATAL_ERROR "${context}: could not locate Ninja command block for '${command_token}':\n${_command_tail}")
  endif()
