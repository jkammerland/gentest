...
foreach(_compdb_index RANGE 0 ${_compdb_last})
  ...
  if(_compdb_file MATCHES "/cases\\.cppm$")
    math(EXPR _authored_case_count "${_authored_case_count} + 1")
  elseif(_compdb_file MATCHES "/tu_[0-9]+_cases\\.registration\\.gentest\\.cpp$")
    math(EXPR _registration_count "${_registration_count} + 1")
  endif()
endforeach()
if(NOT _authored_case_count EQUAL 1)
  message(FATAL_ERROR "Expected one direct authored cases.cppm compile command, got ${_authored_case_count}")
endif()
if(NOT _registration_count EQUAL 1)
  message(FATAL_ERROR "Expected one importer registration compile command, got ${_registration_count}")
endif()

file(GLOB _test_module_wrappers "${_build_dir}/${_generated_root}/*.module.gentest.cppm")
if(_test_module_wrappers)
  message(FATAL_ERROR "Importer registration must not replace the authored module interface: ${_test_module_wrappers}")
endif()
