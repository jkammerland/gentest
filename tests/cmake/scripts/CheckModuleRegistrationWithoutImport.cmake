...
if(NOT _clang OR NOT _clangxx)
  gentest_skip_test("module registration without import regression: clang/clang++ not found")
  return()
endif()
...
if(GENERATOR STREQUAL "Ninja" OR GENERATOR STREQUAL "Ninja Multi-Config")
  ...
  if(NOT _supported_ninja)
    gentest_skip_test("module registration without import regression: ${_supported_ninja_reason}")
    return()
  endif()
...
message(STATUS "Module registration without explicit gentest import regression passed")
