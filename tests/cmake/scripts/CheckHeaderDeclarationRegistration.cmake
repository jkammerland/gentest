...
endforeach()
string(REGEX MATCHALL "\"file\": \"${_src_dir}/dual_target\\.cpp\"" _dual_compdb_entries "${_compdb}")
list(LENGTH _dual_compdb_entries _dual_compdb_count)
if(NOT _dual_compdb_count EQUAL 2)
