...
if(NOT DEFINED REQUIRED_SUBSTRING)
  message(FATAL_ERROR "CheckAllureJunitParity.cmake: REQUIRED_SUBSTRING not set")
endif()
...
string(FIND "${_junit}" "${REQUIRED_SUBSTRING}" _msg_pos)
if(_msg_pos EQUAL -1)
  message(FATAL_ERROR "Expected JUnit to include infra failure substring '${REQUIRED_SUBSTRING}'. File:\n${_junit}\n\nOutput:\n${_all}")
endif()
