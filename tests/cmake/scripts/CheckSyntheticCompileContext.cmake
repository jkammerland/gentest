...
if(_contexts MATCHES "frontend=MSVC")
  set(_expected_default "default=[^\n]*/std:c\\+\\+20")
  set(_expected_feature "feature=[^\n]*/std:c\\+\\+23")
  set(_expected_transitive "transitive=[^\n]*/std:c\\+\\+23")
  set(_expected_extensions "extensions=[^\n]*/std:c\\+\\+20")
else()
  set(_expected_default "default=[^\n]*-std=c\\+\\+20")
  set(_expected_feature "feature=[^\n]*-std=c\\+\\+23")
  set(_expected_transitive "transitive=[^\n]*-std=c\\+\\+23")
...
foreach(_expectation IN ITEMS _expected_default _expected_feature _expected_transitive _expected_extensions)
  if(NOT _contexts MATCHES "${${_expectation}}")
    message(FATAL_ERROR "Synthetic context did not match '${${_expectation}}', got '${_contexts}'")
  endif()
endforeach()
