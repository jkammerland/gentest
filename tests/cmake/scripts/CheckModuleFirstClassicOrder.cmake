...
if(NOT DEFINED SOURCE_DIR OR "${SOURCE_DIR}" STREQUAL "")
  message(FATAL_ERROR "CheckModuleFirstClassicOrder.cmake: SOURCE_DIR not set")
endif()
if(NOT DEFINED BUILD_ROOT OR "${BUILD_ROOT}" STREQUAL "")
  message(FATAL_ERROR "CheckModuleFirstClassicOrder.cmake: BUILD_ROOT not set")
endif()
if(NOT DEFINED GENTEST_SOURCE_DIR OR "${GENTEST_SOURCE_DIR}" STREQUAL "")
  message(FATAL_ERROR "CheckModuleFirstClassicOrder.cmake: GENTEST_SOURCE_DIR not set")
endif()

include("${CMAKE_CURRENT_LIST_DIR}/CheckRunOrFail.cmake")
include("${CMAKE_CURRENT_LIST_DIR}/CheckModuleFixtureCommon.cmake")

set(_work_dir "${BUILD_ROOT}/module_first_classic_order")
...
if(NOT _clang OR NOT _clangxx)
  gentest_skip_test("module-first classic order regression: clang/clang++ not found")
  return()
endif()
...
if(GENERATOR STREQUAL "Ninja" OR GENERATOR STREQUAL "Ninja Multi-Config")
  ...
  if(NOT _supported_ninja)
    gentest_skip_test("module-first classic order regression: ${_supported_ninja_reason}")
    return()
  endif()
...
gentest_check_run_or_fail(
  COMMAND "${CMAKE_COMMAND}" --build "${_build_dir}" --target module_first_classic_order_tests
  WORKING_DIRECTORY "${_work_dir}"
  STRIP_TRAILING_WHITESPACE)

set(_exe "${_build_dir}/module_first_classic_order_tests")
if(CMAKE_HOST_WIN32)
  set(_exe "${_exe}.exe")
endif()
...
string(FIND "${_list_out}" "module_first_classic/basic" _basic_pos)
if(_basic_pos EQUAL -1)
  message(FATAL_ERROR "Expected classic test missing when module TU precedes it.\n${_list_out}")
endif()

gentest_check_run_or_fail(
  COMMAND "${_exe}" --run=module_first_classic/basic
  WORKING_DIRECTORY "${_build_dir}"
  STRIP_TRAILING_WHITESPACE)

message(STATUS "Module-first classic source order regression passed")
