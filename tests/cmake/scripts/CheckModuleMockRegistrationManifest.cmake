...
set(_module_mock_render_timing_count 0)
foreach(_timing_phase_index RANGE 0 ${_timing_phase_count})
  ...
  math(EXPR _module_mock_render_timing_count "${_module_mock_render_timing_count} + 1")
endforeach()
...
if(NOT _module_mock_render_timing_count EQUAL 1)
  message(FATAL_ERROR
    "Module-registration mock attachment render spans were not coalesced into one timing record:\n${_timing_text}")
endif()
