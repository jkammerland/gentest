...
string(FIND "${_build_ninja_text}" "--mock-domain-registry-output" _registry_arg_pos)
if(_registry_arg_pos EQUAL -1)
  message(FATAL_ERROR "Expected build.ninja to pass --mock-domain-registry-output to gentest_codegen")
endif()
string(FIND "${_build_ninja_text}" "--mock-domain-impl-output" _impl_arg_pos)
if(_impl_arg_pos EQUAL -1)
  message(FATAL_ERROR "Expected build.ninja to pass --mock-domain-impl-output to gentest_codegen")
endif()
