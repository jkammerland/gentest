...
gentest_clang_major_version(_path_clang_major "${_fake_path_clangxx}")
if(NOT _path_clang_major STREQUAL "99")
  message(FATAL_ERROR "expected Clang major 99, got '${_path_clang_major}'")
endif()
gentest_clang_major_version(_apple_clang_major "${_fake_apple_clangxx}")
if(NOT _apple_clang_major STREQUAL "15")
  message(FATAL_ERROR "expected AppleClang major 15, got '${_apple_clang_major}'")
endif()
gentest_clang_major_version(_non_clang_major "${_fake_ccache}")
if(NOT _non_clang_major STREQUAL "")
  message(FATAL_ERROR "expected no Clang major for ccache, got '${_non_clang_major}'")
endif()
