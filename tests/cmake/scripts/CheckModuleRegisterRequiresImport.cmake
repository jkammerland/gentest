if(NOT DEFINED SOURCE_DIR OR "${SOURCE_DIR}" STREQUAL "")
  message(FATAL_ERROR "CheckModuleRegisterRequiresImport.cmake: SOURCE_DIR not set")
endif()
if(NOT DEFINED BUILD_ROOT OR "${BUILD_ROOT}" STREQUAL "")
  message(FATAL_ERROR "CheckModuleRegisterRequiresImport.cmake: BUILD_ROOT not set")
endif()
if(NOT DEFINED GENERATOR OR "${GENERATOR}" STREQUAL "")
  message(FATAL_ERROR "CheckModuleRegisterRequiresImport.cmake: GENERATOR not set")
endif()
if(NOT DEFINED GENTEST_SOURCE_DIR OR "${GENTEST_SOURCE_DIR}" STREQUAL "")
  message(FATAL_ERROR "CheckModuleRegisterRequiresImport.cmake: GENTEST_SOURCE_DIR not set")
endif()

include("${CMAKE_CURRENT_LIST_DIR}/CheckModuleFixtureCommon.cmake")

set(_work_dir "${BUILD_ROOT}/module_registration_requires_import")
...
if(NOT _clang OR NOT _clangxx)
  gentest_skip_test("clean module registration import requirement regression: clang/clang++ not found")
  return()
endif()
...
if(GENERATOR STREQUAL "Ninja" OR GENERATOR STREQUAL "Ninja Multi-Config")
  ...
  if(NOT _supported_ninja)
    gentest_skip_test("clean module registration import requirement regression: ${_supported_ninja_reason}")
    return()
  endif()
...
if(_rc EQUAL 0)
  message(FATAL_ERROR
    "Expected configure to fail for a module testcase file set without 'import gentest;'.\n--- stdout ---\n${_out}\n--- stderr ---\n${_err}\n")
endif()

set(_combined "${_out}\n${_err}")
string(FIND "${_combined}" "must directly import gentest" _diagnostic_pos)
if(_diagnostic_pos EQUAL -1)
  message(FATAL_ERROR
    "Expected clean module registration configure failure to mention the direct 'import gentest;' requirement.\n"
    "--- stdout ---\n${_out}\n--- stderr ---\n${_err}\n")
endif()
