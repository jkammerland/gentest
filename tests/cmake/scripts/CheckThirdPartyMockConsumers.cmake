...
if(USE_INSTALLED_GENTEST)
  ...
  if(EXISTS "${_producer_cache_file}")
    ...
    unset(_producer_fmt_dir_line)
  endif()
  unset(_producer_cache_file)
...
if(NOT "${_producer_fmt_dir}" STREQUAL "")
  # Installed gentest exports the exact fmt version used by the producer. Keep
  # the package consumer pointed at that same fmt package instead of allowing a
  # system fmt with a different version to satisfy the nested configure.
  list(APPEND _cmake_cache_args "-Dfmt_DIR=${_producer_fmt_dir}")
endif()
