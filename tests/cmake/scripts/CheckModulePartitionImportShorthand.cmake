...
if(NOT _clang OR NOT _clangxx)
  gentest_skip_test("module partition shorthand regression: clang/clang++ not found")
  return()
endif()
...
if(GENERATOR STREQUAL "Ninja" OR GENERATOR STREQUAL "Ninja Multi-Config")
  ...
  if(NOT _supported_ninja)
    gentest_skip_test("module partition shorthand regression: ${_supported_ninja_reason}")
    return()
  endif()
