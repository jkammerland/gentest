...
execute_process(
  COMMAND "${CMAKE_COMMAND}" -E env
    ...
    "CC=${_bin_dir}/g++"
    "CXX=${_bin_dir}/g++"
    "${PROG}" --check --clang-scan-deps "${_clang_scan_deps}" --external-module-source "gentest.hostclang.provider=${_provider_source_abs}" --compdb "${_module_dir}" --tu-out-dir "${_generated_default_dir}" --module-wrapper-output "${_default_wrapper_abs}" "${_suite_source_abs}"
...
execute_process(
  COMMAND "${CMAKE_COMMAND}" -E env
    ...
    "CC=${_bin_dir}/g++"
    "CXX=${_bin_dir}/g++"
    "${PROG}" --check --clang-scan-deps "${_clang_scan_deps}" --host-clang "${_clangxx_norm}" --external-module-source "gentest.hostclang.provider=${_provider_source_abs}" --compdb "${_module_dir}" --tu-out-dir "${_generated_cli_dir}" --module-wrapper-output "${_cli_wrapper_abs}" "${_suite_source_abs}"
  WORKING_DIRECTORY "${_module_dir}"
...
execute_process(
  COMMAND "${CMAKE_COMMAND}" -E env
    ...
    "${PROG}" --check --clang-scan-deps "${_clang_scan_deps}" --external-module-source "gentest.hostclang.provider=${_provider_source_abs}" --compdb "${_module_dir}" --tu-out-dir "${_generated_env_dir}" --module-wrapper-output "${_env_wrapper_abs}" "${_suite_source_abs}"
  WORKING_DIRECTORY "${_module_dir}"
