...
void native_inherited_concrete() {
    ...
    gentest::expect(mock, &fixture::validation::InheritedConcreteService::inherited).times(1).with(5).returns(50);
    gentest::expect(mock, &fixture::validation::InheritedConcreteService::visible).times(1).with(7).returns(70);
