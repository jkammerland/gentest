...
[[using gentest: test("regressions/manual_free_blocked/create_skip")]] void   create_skip(CreateSkipFx &);
[[using gentest: test("regressions/manual_free_blocked/create_assert")]] void create_assert(CreateAssertFx &);
[[using gentest: test("regressions/manual_free_blocked/setup_skip")]] void    setup_skip(SetupSkipFx &);
[[using gentest: test("regressions/manual_free_blocked/setup_assert")]] void  setup_assert(SetupAssertFx &);
