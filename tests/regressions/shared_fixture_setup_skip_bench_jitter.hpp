...
[[using gentest: bench("regressions/shared_setup_skip_bench_jitter/suite_bench")]] void    suite_bench(NullSuiteFx &);
[[using gentest: jitter("regressions/shared_setup_skip_bench_jitter/global_jitter")]] void global_jitter(NullGlobalFx &);
