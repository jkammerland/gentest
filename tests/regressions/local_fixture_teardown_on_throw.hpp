...
struct BodySkipFx : gentest::FixtureSetup, gentest::FixtureTearDown {
    bool setup_complete = false, teardown_complete = false;
...
[[using gentest: test("regressions/local_fixture_teardown/throwing_case")]] void    throwing_case(BodySkipFx &);
[[using gentest: test("regressions/local_fixture_teardown/setup_throw_case")]] void setup_throw_case(SetupThrowProbeFx &, SetupThrowFx &);
[[using gentest: test("regressions/local_fixture_teardown/setup_skip_case")]] void  setup_skip_case(SetupSkipProbeFx &, SetupSkipFx &);
