...
constexpr std::string_view kFixtureName = "regressions::ScopeConflictFixture";
...
gentest::Case kCases[] = {
    {
        .name             = "regressions/shared_fixture_scope_conflict/smoke",
        .fn               = &smoke,
        .file             = __FILE__,
        .line             = 11,
        .is_benchmark     = false,
...
int main(int argc, char **argv) {
    gentest::detail::register_shared_fixture(gentest::detail::SharedFixtureScope::Suite, "regressions", kFixtureName, &create_fixture,
                                             nullptr, nullptr);
