...
constexpr std::string_view kFixtureName = "regressions::SkippingTeardownFixture";

std::shared_ptr<void> create_fixture(std::string_view, std::string &) { return std::make_shared<int>(1); }

void teardown_skip(void *, std::string &) { gentest::skip("manual-teardown-skip"); }
...
gentest::Case kCases[] = {
    {
        .name             = "regressions/shared_fixture_manual_teardown_skip_exit/smoke",
        .fn               = &smoke,
        .file             = __FILE__,
        .line             = kSmokeLine,
        .is_benchmark     = false,
