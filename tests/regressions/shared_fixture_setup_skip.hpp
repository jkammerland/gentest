...
[[using gentest: test("regressions/shared_setup_skip/suite_free")]] void  suite_free(NullSuiteFx &);
[[using gentest: test("regressions/shared_setup_skip/global_free")]] void global_free(NullGlobalFx &);
