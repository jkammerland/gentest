...
int main(int argc, char **argv) {
    gentest::detail::register_shared_fixture(gentest::detail::SharedFixtureScope::Suite, "regressions", kSuiteFixture, &create_null_fixture,
                                             nullptr, nullptr);

    gentest::detail::register_shared_fixture(gentest::detail::SharedFixtureScope::Global, std::string_view{}, kGlobalFixture,
                                             &create_null_fixture, nullptr, nullptr);
