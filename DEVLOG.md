...
Devlog 2025-10-20 (Clang 18 ABI guard and Fedora CI)
  - CI
      ...
      - Plan: add Linux GCC coverage in CI. Ubuntu covers GCC 12/13 with apt LLVM 20, and Fedora 42 adds GCC 15 using system clang/llvm packages. Once these pass reliably we can fan out to clang-tools 18/19 for the full 3×3 coverage.
  - Tools
