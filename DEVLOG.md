...
Devlog 2025-10-20 (Clang 18 ABI guard and Fedora CI)
  - CI
      ...
      - Plan: add Linux GCC coverage in CI. Start with one Fedora job (GCC 13 + Clang tooling 20, debug/release) sharing the existing vcpkg/bootstrap steps; once stable, expand the matrix to GCC 12/15 and clang-tools 18/19 for full 3×3 coverage.
  - Tools
