...
target("gentest_runtime")
    ...
    add_files("src/recording.cpp", "src/recording_json.cpp", "src/recording_report.cpp")
    add_files("src/log_sink.cpp")
    add_files("src/runtime_context.cpp")
    add_files("src/runner_async_executor.cpp")
    add_files("src/runner_async_scheduler.cpp")
    add_files("src/runner_async_state.cpp")
    add_files("src/runner_async_status_renderer.cpp")
    add_files("src/runner_case_result.cpp")
