...
set(_codegen_exe "${_build_dir}/gentest/tools/gentest_codegen${CMAKE_EXECUTABLE_SUFFIX}")
...
foreach(_module_cache_dir IN LISTS _module_cache_dirs)
  file(GLOB _pcm_files LIST_DIRECTORIES FALSE "${_module_cache_dir}/*.pcm")
  list(SORT _pcm_files)
  list(LENGTH _pcm_files _pcm_file_count)
  _gentest_expect_equal("${_pcm_file_count}" "1" "PCM file count in '${_module_cache_dir}'")
  foreach(_pcm_file IN LISTS _pcm_files)
