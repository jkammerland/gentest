...
set(CMAKE_CXX_FLAGS_DEBUG "-fsanitize=thread -g -O1 -fno-omit-frame-pointer")
set(CMAKE_EXE_LINKER_FLAGS_DEBUG "-fsanitize=thread")
set(CMAKE_MODULE_LINKER_FLAGS_DEBUG "-fsanitize=thread")
set(CMAKE_SHARED_LINKER_FLAGS_DEBUG "-fsanitize=thread")
set(CMAKE_CXX_FLAGS_TSAN "-fsanitize=thread -g -O1 -fno-omit-frame-pointer")
...
if(_supported)
  message(FATAL_ERROR
    "Expected public modules to be disabled for GNU 15.2.1 with ThreadSanitizer under Ninja Multi-Config, but support detection returned enabled")
endif()
if(NOT _reason STREQUAL _expected_reason)
  message(FATAL_ERROR "Expected multi-config reason '${_expected_reason}', got '${_reason}'")
endif()
