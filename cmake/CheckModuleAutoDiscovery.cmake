...
if(NOT _clang OR NOT _clangxx)
  message(STATUS "Skipping module auto-discovery regression: clang/clang++ not found")
  return()
endif()
...
if(GENERATOR STREQUAL "Ninja" OR GENERATOR STREQUAL "Ninja Multi-Config")
  ...
  if(NOT _supported_ninja)
    message(STATUS "Skipping module auto-discovery regression: ${_supported_ninja_reason}")
    return()
  endif()
