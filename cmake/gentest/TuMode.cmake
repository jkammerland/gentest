...
function(_gentest_append_cxx_standard_context_arg args_var target)
    ...
    if(_gentest_extensions AND NOT CMAKE_CXX_COMPILER_FRONTEND_VARIANT STREQUAL "MSVC")
        set(_gentest_standard_prefix "gnu++")
    else()
        set(_gentest_standard_prefix "c++")
    endif()

    set(_gentest_standard_arg "-std=${_gentest_standard_prefix}${_gentest_standard}")
    ...
    foreach(_gentest_feature_standard IN LISTS _gentest_known_standards)
        set(_gentest_standard_arg
            "$<IF:$<IN_LIST:cxx_std_${_gentest_feature_standard},$<TARGET_PROPERTY:${target},COMPILE_FEATURES>>,-std=${_gentest_standard_prefix}${_gentest_feature_standard},${_gentest_standard_arg}>")
    endforeach()
