...
function(_gentest_build_native_scan_inspector out_executable)
    ...
    set(_gentest_helper_build_dir "${CMAKE_BINARY_DIR}/gentest_scan_inspector")
    set(_gentest_helper_executable "${_gentest_helper_build_dir}/gentest_scan_inspector${CMAKE_EXECUTABLE_SUFFIX}")
    ...
    set(_gentest_helper_make_program "")
    if(_gentest_helper_generator STREQUAL "")
        if(DEFINED CMAKE_MAKE_PROGRAM AND NOT "${CMAKE_MAKE_PROGRAM}" STREQUAL "")
            ...
            find_program(_gentest_helper_make_program NAMES ninja ninja-build)
        endif()
    ...
    if(DEFINED CMAKE_CXX_COMPILER AND NOT "${CMAKE_CXX_COMPILER}" STREQUAL "")
        list(APPEND _gentest_configure_cmd "-DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER}")
    endif()
