...
function(gentest_add_mocks target)
    ...
    if(GENTEST_HEADER_NAME AND NOT _gentest_textual_defs)
        message(FATAL_ERROR
            "gentest_add_mocks(${target}): HEADER_NAME is only supported when DEFS includes at least one textual header/source file. "
            "Module-only explicit mock targets publish modules, not generated public headers.")
    endif()
    ...
    _gentest_materialize_explicit_module_mock_defs("${_gentest_output_dir}" _gentest_materialized_module_defs _gentest_module_public_files ${_gentest_module_defs})
