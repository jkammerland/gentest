...
string(REGEX MATCHALL "\[ PASS \]" _pass_matches "${out}")
list(LENGTH _pass_matches pass_count)
string(REGEX MATCHALL "\[ FAIL \]" _fail_matches "${out}")
list(LENGTH _fail_matches fail_count)
string(REGEX MATCHALL "\[ SKIP \]" _skip_matches "${out}")
...
# When FAIL is zero, rc should be 0.
if(FAIL EQUAL 0 AND NOT rc EQUAL 0)
