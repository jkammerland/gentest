...
function(_gentest_collect_build_root_candidates out_var build_root)
...
function(gentest_append_public_dependency_include_args out_var)
  ...
  _gentest_collect_build_root_candidates(_build_root_candidates "${_build_root}")
  foreach(_candidate_root IN LISTS _build_root_candidates)
    _gentest_append_include_arg_unique(_args "${_candidate_root}/_deps/fmt-src/include")

    file(GLOB _vcpkg_include_dirs LIST_DIRECTORIES TRUE "${_candidate_root}/vcpkg_installed/*/include")
    ...
    set(_cache_file "${_candidate_root}/CMakeCache.txt")
