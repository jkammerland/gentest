...
if(NOT _clang OR NOT _clangxx)
  message(FATAL_ERROR "module manual include whitespace regression requires a usable clang/clang++ pair")
endif()
...
if(GENERATOR STREQUAL "Ninja" OR GENERATOR STREQUAL "Ninja Multi-Config")
  ...
  if(NOT _supported_ninja)
    message(FATAL_ERROR "module manual include whitespace regression requires Ninja 1.11+: ${_supported_ninja_reason}")
  endif()
