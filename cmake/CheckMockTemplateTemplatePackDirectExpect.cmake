...
if(NOT DEFINED PROG OR "${PROG}" STREQUAL "")
  message(FATAL_ERROR "CheckMockTemplateTemplatePackDirectExpect.cmake: PROG not set")
endif()
if(NOT DEFINED BUILD_ROOT OR "${BUILD_ROOT}" STREQUAL "")
  message(FATAL_ERROR "CheckMockTemplateTemplatePackDirectExpect.cmake: BUILD_ROOT not set")
endif()
if(NOT DEFINED GENTEST_SOURCE_DIR OR "${GENTEST_SOURCE_DIR}" STREQUAL "")
  message(FATAL_ERROR "CheckMockTemplateTemplatePackDirectExpect.cmake: GENTEST_SOURCE_DIR not set")
endif()
if(NOT DEFINED SOURCE_DIR OR "${SOURCE_DIR}" STREQUAL "")
  message(FATAL_ERROR "CheckMockTemplateTemplatePackDirectExpect.cmake: SOURCE_DIR not set")
endif()
if(NOT DEFINED GENERATOR OR "${GENERATOR}" STREQUAL "")
  message(FATAL_ERROR "CheckMockTemplateTemplatePackDirectExpect.cmake: GENERATOR not set")
endif()

include("${CMAKE_CURRENT_LIST_DIR}/CheckRunOrFail.cmake")

set(_work_dir "${BUILD_ROOT}/mock_template_template_pack_direct_expect")
...
message(STATUS "Configure mock_template_template_pack_direct_expect fixture...")
...
set(_build_cmd
  "${CMAKE_COMMAND}"
  --build "${_build_dir}"
  --target mock_template_template_pack_direct_expect)
if(DEFINED BUILD_TYPE AND NOT "${BUILD_TYPE}" STREQUAL "")
  list(APPEND _build_cmd --config "${BUILD_TYPE}")
endif()

message(STATUS "Build mock_template_template_pack_direct_expect fixture...")
gentest_check_run_or_fail(
  COMMAND
    ${_build_cmd}
  STRIP_TRAILING_WHITESPACE
...
if(DEFINED BUILD_TYPE AND NOT "${BUILD_TYPE}" STREQUAL "" AND EXISTS "${_build_dir}/bin/${BUILD_TYPE}/mock_template_template_pack_direct_expect${CMAKE_EXECUTABLE_SUFFIX}")
