...
function(gentest_add_check_death)
    ...
    if(GENTEST_REQUIRED_SUBSTRINGS)
        ...
        string(REPLACE ";" "\\;" _required_substrings_escaped "${_required_substrings_joined}")
        list(APPEND _defines "REQUIRED_SUBSTRINGS=${_required_substrings_escaped}")
        unset(_required_substrings_joined)
        unset(_required_substrings_escaped)
    endif()
