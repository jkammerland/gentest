...
function(gentest_add_check_death)
    ...
    if(GENTEST_REQUIRED_SUBSTRINGS)
        string(JOIN ";" _required_substrings_joined ${GENTEST_REQUIRED_SUBSTRINGS})
        string(HEX "${_required_substrings_joined}" _required_substrings_hex)
        list(APPEND _encoded_defines "REQUIRED_SUBSTRINGS=${_required_substrings_hex}")
        unset(_required_substrings_joined)
        unset(_required_substrings_hex)
    endif()
