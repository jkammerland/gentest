...
gentest_fixture_make_compdb_entry(_source_entry
  ...
  FILE "suite.cppm"
  ARGUMENTS "${_fake_gxx_abs}" "-std=c++20" "-I${_source_dir_norm}/include" "-c" "suite.cppm" "-o" "suite.o")

gentest_fixture_make_compdb_entry(_wrapper_entry
  DIRECTORY "${_work_dir_norm}"
  FILE "${_wrapper_abs}"
  ARGUMENTS "${_clangxx_norm}" "-std=c++20" "-I${_source_dir_norm}/include" "-c" "${_wrapper_abs}" "-o" "${_wrapper_abs}.o")
