...
| Configure-time source-inspector probe helpers in CMake | Removed in story 037 wave 1 | `1.0.0` | N/A | Removed after story 033 closed | Tool-owned source/module classification, mock-manifest module metadata, codegen-emitted explicit mock aggregate modules, and manifest-declared textual wrapper semantics | [story 037](docs/stories/037_codegen_contract_cleanup_campaign.md) |
...
| `meson/*.in` generated-source skeletons | Removed in story 037 wave 2 | `1.0.0` | N/A | Removed after story 015 closed | `gentest_codegen --textual-wrapper-output` and `--mock-public-header` emit final textual sources/headers | [story 037](docs/stories/037_codegen_contract_cleanup_campaign.md) |
| `xmake/templates/*.in` generated-source skeletons | Wrapper cleanup scheduled | `1.0.0` | N/A | First release after story 015 closes | Final generated sources emitted by `gentest_codegen` | [story 037](docs/stories/037_codegen_contract_cleanup_campaign.md) |
